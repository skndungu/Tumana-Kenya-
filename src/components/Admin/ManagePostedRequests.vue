<template>
   <div id="posted-requests">
       <v-container>
           <v-layout>
            <v-flex xs12 sm6 class="text-xs-center text-sm-right">
                <v-btn large class="primary" router to="/">New requests</v-btn>
            </v-flex>
            <v-flex xs12 sm6 class="text-xs-center text-sm-left">
                <v-btn large class="success" router to="/">Delivered </v-btn>
            </v-flex>
           </v-layout>
       </v-container>
       <v-layout>
             ...
             <v-flex xs12 sm6 offset-sm3 >
                 ...
                 <v-card-title>
                    <h2><span class="header">Title: </span> {{post.title}}</h2>
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                        <app-delivered-dialog :requestId="post.id"></app-delivered-dialog>
                        </v-card-actions>
